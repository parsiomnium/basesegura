...
export default function ProtegermePage() {
  const articles = getArticlesBySection('protegerme')
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold mb-6">Quiero protegerme</h1>
      <ul className="space-y-4">
        {articles.map(article => (
          <li key={article.slug}>
            <Link
              href={`/protegerme/${article.slug}`}
