...
export default function MePasoAlgoPage() {
  const articles = getArticlesBySection('me-paso-algo')
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold mb-6">Me pasó algo</h1>
      <ul className="space-y-4">
        {articles.map(article => (
          <li key={article.slug}>
            <Link
              href={`/me-paso-algo/${article.slug}`}
