...
const BRAND_DOMAINS: Record<string, string[]> = {
  ...
  // Bancos Chile (verificados 2026-07-23)
  'santander': ['santander.cl'],
  'bancoestado': ['bancoestado.cl'],
  'bancochile': ['bancochile.cl'],
  'bancodechile': ['bancochile.cl'],
  'scotiabank': ['scotiabank.cl', 'scotiabankchile.cl'],
  'bci': ['bci.cl'],
  'bancofalabella': ['bancofalabella.cl'],
  'bancoripley': ['bancoripley.cl'],
  'itau': ['itau.cl'],
  // Tiendas Chile (verificados 2026-07-23)
  'mercadolibre': ['mercadolibre.cl', 'mercadolibre.com', 'mercadopago.cl', 'mercadopago.com'],
  'falabella': ['falabella.com', 'bancofalabella.cl'],
  'ripley': ['ripley.cl', 'bancoripley.cl'],
  'paris': ['paris.cl'],
  'lider': ['lider.cl'],
